...
class Application:
    ...
    def __init__(self, width=1280, height=720):
        ...
        self.sampleMap = Map(tilesDict={str(i):StaticTile(i, height-32, 0.333, path="assets/sprites/forest/forestGrass.png") for i in range(0, width, 32)}, player=Player(width//2, 400, 1))
        ...
        self.sampleMap.tilesDict.update({str(i+(width*3)):StaticTile(i, height+512, 0.333, path="assets/sprites/forest/forestGrass.png") for i in range(-256, width + 256, 32)})
        self.sampleMap.tilesDict.update({"512":Platform(512, height-32, 0.333, path="assets/sprites/carpentry/singleWoodenPlatformBothSides.png")})
        self.sampleMap.tilesDict.update({"plat1":Platform(512, height+64, 0.333, path="assets/sprites/carpentry/singleWoodenPlatformExtension.png")})
        self.sampleMap.tilesDict.update({"plat2":Platform(512, height+160, 0.333, path="assets/sprites/carpentry/singleWoodenPlatformExtension.png")})
        self.sampleMap.tilesDict.update({"plat3":Platform(512, height+256, 0.333, path="assets/sprites/carpentry/singleWoodenPlatformExtension.png")})
        self.sampleMap.tilesDict.update({"plat4":Platform(512, height+352, 0.333, path="assets/sprites/carpentry/singleWoodenPlatformExtension.png")})
        self.sampleMap.tilesDict.update({"plat5":Platform(512, height+448, 0.333, path="assets/sprites/carpentry/singleWoodenPlatformExtension.png")})
        #self.sampleMap.update({""})
        #physics engine
